...
% $Revision: 1.9.4.13 $  $Date: 2010/03/04 16:22:50 $
...
if newTrimming
    ...
    switch(objectType)
        ...
        case 'geosurface'
            ...
            lon0 = origin(2);
            [rng, az] = ...
                distance('gc', lat0, lon0, lat, lon, radius, 'radians');
            
            % Trim data exceeding specified range from the origin
            [rng, az, ~] = trimdata( ...
                rng, [-inf maxRange*radius], az, [-inf inf], 'surface');
