...
%  availability. LISTMODE is a string with value 'mapprojection',
%  'geotiff', 'geotiff2mstruct', or 'all'. The default value is
%  'mapprojection'.
%
%  S = PROJLIST(LISTMODE) returns a structure array containing projection
%  names, IDs and availability.  
%
...
% $Revision: 1.1.6.3 $  $Date: 2006/12/10 20:05:48 $
