...
% $Revision: 1.6.4.6 $  $Date: 2009/03/30 23:39:35 $
...
% for elliptical geoid.  Until the difference can be resolved, HAMMER and
% BRIES will ignore the elliptical component of the geoid vector."
if nargin > 1
    mstruct = varargin{1};
    mstruct.geoid(2) = 0;
    varargin{1} = mstruct;
