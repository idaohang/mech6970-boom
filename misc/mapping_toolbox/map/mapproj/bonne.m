...
% $Revision: 1.9.4.4 $  $Date: 2007/03/27 19:13:30 $
...
latgeod = convertlat(...
    mstruct.geoid, lat, 'rectifying', 'geodetic', 'nocheck');
...
rectifies = convertlat(...
    mstruct.geoid, parallels, 'geodetic', 'rectifying', 'nocheck');
