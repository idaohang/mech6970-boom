...
%  distance units as the geoid.  The orthographic projection is a limiting
%  form with the observer at an infinite distance.
%  
%  This projection is available only on the sphere.

% Copyright 1996-2007 The MathWorks, Inc.
% $Revision: 1.6.4.5 $  $Date: 2007/03/27 19:14:26 $
