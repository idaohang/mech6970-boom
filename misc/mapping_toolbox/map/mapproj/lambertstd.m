...
% $Revision: 1.1.6.5 $  $Date: 2008/04/03 03:13:45 $
...
conformals = convertlat(...
    mstruct.geoid, parallels, 'geodetic', 'conformal', 'nocheck');
...
chi0 = convertlat(...
    mstruct.geoid, phi0, 'geodetic', 'conformal', 'nocheck');
