...
% $Revision: 1.10.4.11 $  $Date: 2010/03/04 16:22:49 $
...
lat = convertlat(mstruct.geoid, lat, 'geodetic', 'authalic', 'nocheck');
...
lat = convertlat(mstruct.geoid, lat, 'authalic', 'geodetic', 'nocheck');
...
origin(1) = convertlat(mstruct.geoid, ...
                       origin(1), 'geodetic', 'authalic', 'nocheck');
...
beta0 = convertlat(mstruct.geoid, phi0, 'geodetic', 'authalic', 'nocheck');
