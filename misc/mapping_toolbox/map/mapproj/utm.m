...
% $Revision: 1.6.4.5 $  $Date: 2007/03/27 19:14:22 $
...
a = mstruct.geoid(1);            % length of semimajor axis
e = mstruct.geoid(2);            % eccentricity
e2 = e^2; e4 = e2^2; e6 = e2^3;  % powers of eccentricity
ep2 = e2/(1-e2);                 % second eccentricity
