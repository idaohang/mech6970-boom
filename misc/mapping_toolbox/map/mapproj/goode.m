...
% $Revision: 1.9.4.6 $  $Date: 2009/03/30 23:39:38 $
...
breakpt = degtorad(dms2degrees([40, 44,11.8]));
...
breakpt = radius*degtorad(dms2degrees([40, 44, 11.8])); % was previously dms2rad(4444);
