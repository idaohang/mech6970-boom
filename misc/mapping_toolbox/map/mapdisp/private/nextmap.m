...
% $Revision: 1.1.6.3 $  $Date: 2009/06/16 04:12:41 $
...
elseif iscell(ax)
    ...
    error('map:nextmap:invalidInput', ...
        ['Internal error: Input to private function %s must be either an ', ...
        ' axes handle or a cell array.'], mfilename)
end
