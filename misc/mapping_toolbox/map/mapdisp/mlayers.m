...
%   specified by the string FILENAME, and plots them on the current map
%   axes.
%
...
%   The DISPLAY_STRUCTS input can be constructed from the current
%   workspace using the ROOTLAYR function.
%
...
%
%   See also MOBJECTS, DISPLAYM, EXTRACTM, MOBJECTS, ROOTLAYR.

% Copyright 1996-2009 The MathWorks, Inc.
% $Revision: 1.13.4.7 $  $Date: 2009/11/09 16:26:36 $
