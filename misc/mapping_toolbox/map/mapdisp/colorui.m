...
%  color triplet.  On Windows(R) platforms, COLORUI will produce the
%  same interface as UISETCOLOR.  On other machines, COLORUI produces a
%  platform-independent dialog for specifying the color values.
%
...
% $Revision: 1.4.4.8 $  $Date: 2009/05/14 17:06:10 $
...
buttonname = get(object,'String');
if strcmpi(buttonname,'Accept')
