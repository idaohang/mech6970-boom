...
%  string, ACTION, as defined in the following table:
%
%     VALUE      ACTION
%     -----      -------
...
%
%  SHOWAXES(COLORSTR) sets the Cartesian axes to the color specified by the 
%  string, COLORSTR.
%
...
% $Revision: 1.8.4.4 $  $Date: 2009/11/09 16:26:43 $
