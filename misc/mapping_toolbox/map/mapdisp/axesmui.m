...
% $Revision: 1.15.4.13 $  $Date: 2009/11/09 16:26:19 $
...
if strcmp(mstruct.mapprojection,'utm')
    ...
    if isempty(txtmsg)
        ...
        [mstruct.maplatlimit, ...
         ...
         mstruct.origin, ...
         mstruct.flatlimit] ...
            = fromDegrees(angleunits, ...
                ltlim, ltlim, [0 min(lnlim)+3 0], ltlim);
...
elseif strcmp(mstruct.mapprojection,'ups')
    ...
    if strmatch(mstruct.zone,'north')
        ...
        [mstruct.trimlat, ...
         ...
         mstruct.mlinelimit] ...
             = fromDegrees(angleunits, ...
                 [-Inf 6],[84 90],[-180 180],[90 0 0],[-Inf 6],[84 89]);
    elseif strmatch(mstruct.zone,'south')
        ...
        [mstruct.trimlat, ...
         ...
         mstruct.mlinelimit] ...
             = fromDegrees(angleunits, ...
                 [-Inf 10],[-90 -80],[-180 180],[-90 0 0],[-Inf 10],[-89 -80]);
    else
