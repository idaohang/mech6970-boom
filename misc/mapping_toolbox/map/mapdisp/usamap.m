...
%   or group of states specified by input STATE.  STATE may be a string or
%   a cell array of strings, where each string contains the name of a state
%   or 'District of Columbia'.  Alternatively, STATE may be a standard
%   two-letter U.S. Postal Service abbreviation.  The map axes is created
%   in the current axes and the axis limits are set tight around the map
%   frame.
%
...
%
%   h = USAMAP('all') constructs three empty axes, inset within a single
%   figure, for the conterminous states, Alaska, and Hawaii, respectively,
%   using projection parameters suggested by the U.S. Geological Survey.
%   The handles for the three map axes are returned in h.  h(1) is for the
%   conterminous states, h(2) is for Alaska, and h(3) is for Hawaii.
%
%   h = USAMAP('allequal') constructs the map axes with Alaska and Hawaii
%   at the same scale as the conterminous states.  
%  
...
%   end
%
%   See also AXESM, AXESSCALE, GEOSHOW, PAPERSCALE, SELECTMOVERESIZE,
%            TIGHTMAP, WORLDMAP.

% Copyright 1996-2009 The MathWorks, Inc.
% $Revision: 1.8.4.8 $  $Date: 2010/11/17 11:25:11 $ 
