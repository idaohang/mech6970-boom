...
%
%  See also MAPTRIML, MAPTRIMP, MAPTRIMS, SEEDM.

% Copyright 1996-2009 The MathWorks, Inc.
% $Revision: 1.8.4.5 $  $Date: 2009/11/09 16:26:33 $
...
%  the data grid.
      ...
      map = imbedm(lat,lon,1,map,maplegend);
	  ...
	  while 1   %  Prompt until correct, or cancel
		  ...
		  if trimflag
              ...
              try
                  ...
                  %  Trim the map data
                  [submap,sublegend] = maptrims(map,maplegend,latlim,lonlim,scale);
                  break;
