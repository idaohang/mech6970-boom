...
% $Revision: 1.2.4.8 $  $Date: 2010/10/11 14:47:45 $
% Written by: L. Job
...
switch nargin
    case 1
        ...
        if isempty(hlight)
            error(['map:' mfilename ':mapdispError'], ...
                'No light objects exist in axes H')
        end
        ...
        coast = load('coast');
        hold on
        geoshow(coast.lat, coast.long, 'Color',.65*[1 1 1]);
