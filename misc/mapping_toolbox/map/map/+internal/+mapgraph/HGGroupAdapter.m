...
% $Revision: 1.1.6.2 $  $Date: 2010/05/13 17:37:08 $

classdef HGGroupAdapter < hgsetget
    ...
    properties (Hidden = true, GetAccess = public, SetAccess = protected)
        % Property that determines if object is loaded from file
    ...
    methods
        ...
        function h = HGGroupAdapter(ax)
            ...
            h.HGGroup = hggroup('Parent',ax, ...
                'DeleteFcn',@(hSrc, eventdata) delete(h));
            
            % Use appdata to establish a link back from the hggroup.
            setappdata(h.HGGroup,'mapgraph',h)
        end
