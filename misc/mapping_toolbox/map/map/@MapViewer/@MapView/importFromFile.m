...
%   $Revision: 1.1.6.8 $  $Date: 2010/11/17 11:24:49 $

map = this.getMap;
[~, name, ext] = fileparts(filename);
this.setCurrentPath(filename);

[dataArgs, ~, info] = mapgate('readMapData',[],filename);
...
switch lower(ext)
    ...
    case {'.tif','.tiff','.jpg','.jpeg','.png'}
        ...
        layer = createLayer(map, name, dataArgs{1}, cmap, R, info);
    ...
    case {'.shp','.shx','.dbf'}
        ...
        layer = mapgate('createVectorLayer', shapeData, name);
