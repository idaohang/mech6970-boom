...
%   data from the referencing matrix R and the 2-D array of data 
%   values Z.  
%
%   GRIDDEDCOMPONENT(X,Y,Z)constructs an object to store the 
%   X and Y geolocation vectors and the 2-D array of data values Z.
%
...
%   $Revision: 1.1.6.3 $  $Date: 2006/12/10 20:04:26 $
