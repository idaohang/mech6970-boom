...
%   object.  ROW and COL are vectors or arrays of matching size. The
...
% $Revision: 1.1.6.7 $  $Date: 2010/10/11 14:47:24 $ 

error(nargchk(2,3,nargin,'struct'))
error(nargoutchk(0,2,nargout,'struct'))

% Validate referencing matrix or MapRasterReference object.
internal.map.validateRasterReference(R, ...
    {'spatialref.MapRasterReference'}, 'pix2map', 'R', 1)
