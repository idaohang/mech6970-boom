...
%   regular data grid, Z.  R can be a spatialref.GeoRasterReference
...
%
%   Z = IMBEDM(LAT, LON, VALUE, Z, R, UNITS) specifies the units
%   of the vectors LAT and LON, where UNITS is any valid angle units
%   string ('degrees' by default).
%
...
% $Revision: 1.9.4.8 $  $Date: 2010/11/17 11:24:18 $
...
[r, c, indxPointOutsideGrid] = setpostn(Z, R, lat, lon);
