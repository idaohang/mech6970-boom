...
%   R is a 3-by-2 referencing matrix or a spatialref.MapRasterReference
%   object.  HEIGHT and WIDTH are the image dimensions.  X and Y are
%   4-by-1 column vectors containing the map coordinates of the outer
%   corners of the corner pixels, in the following order:
%
...
% $Revision: 1.1.6.8 $  $Date: 2010/10/11 14:47:21 $ 
...
if closeOutline
    xi = R.XLimIntrinsic([1 1 2 2 1])';
    yi = R.YLimIntrinsic([1 2 2 1 1])';
else
    xi = R.XLimIntrinsic([1 1 2 2])';
    yi = R.YLimIntrinsic([1 2 2 1])';
end
