...
%     be introduced when using the TGRLINE or VMAP0DATA file readers)
%
...
%
%   GEOSTRUCT = UPDATEGEOSTRUCT(DISPLAY_STRUCT, STR) selects only
%   elements whose 'tag' field begins with the string STR (and whose
%   type field is either 'line' or 'patch'). The selection is
%   case-insensitive.
%
...
% $Revision: 1.1.6.9 $  $Date: 2010/09/24 14:33:32 $
