...
%symbolizeMapVectors Symbolize and display a geostruct
%
...
%   attributes of the features in the geostruct S to graphics properties.
%   This step is skipped for empty SYMSPEC. Each feature is displayed using
%   the function handle given in PLOTFCN.  The return value hg is a handle
%   to an hggroup object with one graphics object child for each feature in
%   S.  In the case of a polygon geostruct, each child is a modified patch
%   object; otherwise it is a line object.  defaultProps and otherProps are
%   both cell arrays containing name-value pairs for graphic properties,
%
...
%           gcm, s.Lat, s.Lon, 'geopolygon', @mappolygon, varargin{:}),...
%           {'EdgeColor','green'},{});
%
...
% $Revision: 1.1.6.3 $  $Date: 2008/06/16 16:47:04 $
...
% Plot the map feature in the scalar geostruct, s, with properties, props,
