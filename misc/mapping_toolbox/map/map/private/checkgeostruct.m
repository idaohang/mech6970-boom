...
% $Revision: 1.1.6.2 $  $Date: 2009/07/06 20:36:14 $

% Verify the input is a non-empty structure.
checkinput(S, {'struct'}, {'vector','nonempty'}, ...
...
assert(iscell(geometry), ...
    eid('nonStrGeometry1'), ...
    ['Function %s expected a geostruct where the ''Geometry'' field\n', ...
    'contains a string for all elements.'], function_name);
