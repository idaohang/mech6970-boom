...
%   case-insensitive string UNITS equals 'degrees', or 'radians' if
%   UNITS equals 'radians'.  Given a truncated version of either
%   'degrees' or 'radians', CHECKANGLEUNITS returns the full string.
%   Otherwise, an error is issued. 

% Copyright 2007-2009 The MathWorks, Inc.
% $Revision: 1.1.6.1 $  $Date: 2009/03/09 19:16:08 $
