...
%   referencing matrix, or a spatialref.GeoRasterReference object.
%
...
% $Revision: 1.9.4.11.2.1 $  $Date: 2010/12/03 21:43:42 $
...
elseif refvecInput
    % Referencing vector
    R = [S.DeltaLatDenominator/S.DeltaLatNumerator S.Latlim(2) S.Lonlim(1)];
else
    % Referencing matrix
    R = convertToReferencingMatrix(S);
end
...
if nargin==4,
  if ~ischar(arg3), % imresize(r,g,b,m)
