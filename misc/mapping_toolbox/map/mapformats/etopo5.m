...
%  data files. 
%
%  For details on locating ETOPO5 data for download over the Internet, see
...
%  $Revision: 1.1.6.4 $  $Date: 2009/11/09 16:26:55 $

error('map:etopo5:obsolete', ...
    'Function %s is obsolete.\nUse %s instead.', ...
    upper(mfilename), 'ETOPO');
