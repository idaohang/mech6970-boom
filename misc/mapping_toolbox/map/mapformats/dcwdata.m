...
%   returned as a Mapping Toolbox display structure.  It can be
%   displayed with function DISPLAYM or converted to a geostruct
%   with function UPDATEGEOSTRUCT.
%   
%   [S1, S2, ...]  = ...
...
%   superseded by the Vector Map Level 0 (VMAP0). The documentation  for
%   the VMAP0DATA function has more information on VMAP0.
%
%   See also DCWGAZ, DCWREAD, DCWRHEAD, VMAP0DATA, MLAYERS, DISPLAYM,
%   EXTRACTM, UPDATEGEOSTRUCT.

% Copyright 1996-2008 The MathWorks, Inc.
% $Revision: 1.1.6.6 $  $Date: 2008/06/16 16:47:23 $
% Written by:  W. Stumpf
